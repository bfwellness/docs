...
**Integration**: Automatica via Make.com per master data
**Status**: ✅ Documentato

[Documentazione →](../bf/monday)

#### Make.com (External)

**Purpose**: Automazioni tra Firebase ↔ Monday.com
**Status**: ✅ Documentato (8 scenari sincronizzazione + 3 scenari operativi)

[Documentazione →](../bf/make)
