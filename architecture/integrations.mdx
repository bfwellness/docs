...
**Status**: ⚠️ **Non documentato** - Richiede token API valido

**Estimated Scenarios**:
1. Firestore appointment onCreate → Monday.com board item
2. Firestore payment onCreate → Monday.com billing update
3. Monday.com task completed → Firestore notification
...
**Integration**: Via Make.com scenarios (non diretta)
