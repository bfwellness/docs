...
- Definire checklist sicurezza (scan malware, revisione utenti, rotazione password).
- Stabilire piano editoriale per blog/newsletter sincronizzato con marketing.
- Documentare automazioni Make collegate ai form (vedi [Automazioni Make.com](../make)).
- Valutare integrazione analytics/heatmap per ottimizzare conversioni.
- **Documentare percorso esatto cartella listini FTP** dopo verifica con IT.
