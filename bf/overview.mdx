...
- **Gestionale Monday.com** – workspace organizzativo dove lo staff traccia attività operative, richieste e stati di avanzamento. Il gestionale è integrato con Firebase tramite Make.com per la sincronizzazione automatica dei master data (categorie, servizi, strutture, staff). Eventuali modifiche manuali devono mantenere coerenza con le collezioni Firestore, soprattutto per pianificazione trattamenti e campagne marketing. Maggiori dettagli nella pagina [Gestionale Monday.com](monday).
